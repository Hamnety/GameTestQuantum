...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Damage : Quantum.IComponent {
    public const Int32 SIZE = 24;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    public FP MaxYPossition;
    [FieldOffset(16)]
    public FP MeterEquals;
    [FieldOffset(0)]
    public Int32 Value;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 83;
        hash = hash * 31 + MaxYPossition.GetHashCode();
        hash = hash * 31 + MeterEquals.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        FP.Serialize(&p->MaxYPossition, serializer);
        FP.Serialize(&p->MeterEquals, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  public unsafe partial class Frame {
    ...
    static partial void InitStaticGen() {
      ComponentTypeId.Setup(() => {
        ComponentTypeId.Add<Quantum.Damage>(Quantum.Damage.Serialize, null, null, ComponentFlags.None);
    ...
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.Damage>();
      BuildSignalsArrayOnComponentRemoved<Quantum.Damage>();
  ...
  public unsafe partial class ComponentPrototypeVisitor : Prototypes.ComponentPrototypeVisitorBase {
    public virtual void Visit(Prototypes.Damage_Prototype prototype) {
...
namespace Quantum.Prototypes {
  ...
  public sealed unsafe partial class Damage_Prototype : ComponentPrototype<Damage> {
    public Int32 Value;
    public FP MeterEquals;
    public FP MaxYPossition;
  ...
  public unsafe partial class FlatEntityPrototypeContainer {
    [ArrayLength(0, 1)]
    public List<Prototypes.Damage_Prototype> Damage;
    [ArrayLength(0, 1)]
    ...
    public unsafe partial class StoreVisitor {
      public override void Visit(Prototypes.Damage_Prototype prototype) {
        Storage.Store(prototype, ref Storage.Damage);
      }
